...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2125433368;
...
impl SseDecode for crate::ark::balance::ArkBalance {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        let mut var_boarding = <crate::ark::balance::ArkBoarding>::sse_decode(deserializer);
        return crate::ark::balance::ArkBalance {
...
impl SseDecode for crate::ark::transactions::ArkTransaction {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                ...
                return crate::ark::transactions::ArkTransaction::Boarding {
                    txid: var_txid,
                    sats: var_sats,
            ...
            1 => {
                ...
                return crate::ark::transactions::ArkTransaction::Commitment {
                    txid: var_txid,
                    sats: var_sats,
            ...
            2 => {
                ...
                let mut var_createdAt = <i64>::sse_decode(deserializer);
                return crate::ark::transactions::ArkTransaction::Redeem {
                    txid: var_txid,
                    sats: var_sats,
...
impl SseDecode for Vec<crate::ark::transactions::ArkTransaction> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = Vec::with_capacity(len_ as usize);
        for idx_ in 0..len_ {
            ans_.push(<crate::ark::transactions::ArkTransaction>::sse_decode(
                deserializer,
            ));
        }
        return ans_;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__ark__client__ArkWallet_balance_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__ark__client__ArkWallet_can_settle_boarding_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__ark__client__ArkWallet_collaborative_redeem_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__ark__client__ArkWallet_get_boarding_status_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        9 => wire__crate__ark__client__ArkWallet_send_off_chain_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__ark__client__ArkWallet_send_on_chain_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__ark__client__ArkWallet_settle_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__ark__client__ArkWallet_settle_boarding_transactions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        17 => wire__crate__ark__storage__InMemoryDb_default_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        2 => wire__crate__ark__client__ArkWallet_boarding_address_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__ark__client__ArkWallet_offchain_address_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__ark__client__ArkWallet_onchain_address_impl(ptr, rust_vec_len, data_len),
        11 => wire__crate__ark__client__ArkWallet_server_info_impl(ptr, rust_vec_len, data_len),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::ark::balance::ArkBalance {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::ark::balance::ArkBalance
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::ark::balance::ArkBalance>
    for crate::ark::balance::ArkBalance
{
    fn into_into_dart(self) -> crate::ark::balance::ArkBalance {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::ark::balance::ArkBoarding {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::ark::balance::ArkBoarding
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::ark::balance::ArkBoarding>
    for crate::ark::balance::ArkBoarding
{
    fn into_into_dart(self) -> crate::ark::balance::ArkBoarding {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::ark::transactions::ArkTransaction {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::ark::transactions::ArkTransaction::Boarding {
                txid,
                sats,
                confirmed_at,
            } => [
            ...
            .into_dart(),
            crate::ark::transactions::ArkTransaction::Commitment {
                txid,
                sats,
                created_at,
            } => [
            ...
            .into_dart(),
            crate::ark::transactions::ArkTransaction::Redeem {
                txid,
                sats,
                is_settled,
                created_at,
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::ark::transactions::ArkTransaction
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::ark::transactions::ArkTransaction>
    for crate::ark::transactions::ArkTransaction
{
    fn into_into_dart(self) -> crate::ark::transactions::ArkTransaction {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::ark::balance::ArkBalance {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <crate::ark::balance::ArkBoarding>::sse_encode(self.boarding, serializer);
    }
}

impl SseEncode for crate::ark::balance::ArkBoarding {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
...
impl SseEncode for crate::ark::transactions::ArkTransaction {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::ark::transactions::ArkTransaction::Boarding {
...
impl SseEncode for Vec<crate::ark::transactions::ArkTransaction> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::ark::transactions::ArkTransaction>::sse_encode(item, serializer);
        }
    }
}
